import sys
sys.path.append("/Users/Vmaha/Desktop/Bitcoin")  # unchanged
...
if __name__ == "__main__":
    ...
    if accounts:
        ...
        print(f"Public Address: {accounts[-1]['PublicAddress']}")
    else:
        acct = account()
        acct.createKeys()
        db.write([acct.__dict__])
        print("New account created and saved.")